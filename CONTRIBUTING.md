# Contributing to Zero Bounce Java SDK
...
Open an [issue](https://github.com/zerobounce/zero-bounce-java-sdk-setup/issues) and include:

* Environment details (Java version, build tool)
* Steps to reproduce
